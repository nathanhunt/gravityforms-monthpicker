...
The code below is part of Gravity Forms Monthpicker
...
*/
(function ($) {
	$('.gfmonthpicker').each(function () {
		var element = jQuery(this),
			inputId = this.id,
			optionsObj = {ShowIcon: false};
		...
		optionsObj = gform.applyFilters('gform_monthpicker_options_pre_init', optionsObj, inputId[1], inputId[2]);
		element.MonthPicker(optionsObj);
	});
})(jQuery);